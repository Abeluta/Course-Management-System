  ...
  <div class="outer">
    <div>
      ...
      <div v-else-if="status === 2" class="register-student">
        ...
        <div>
          <div><input type="text" placeholder="账号" v-model="account" maxlength="20" @blur="verifyAccountExist" @focus="focusBorder(1)" /><div></div></div>
          <div><input type="password" placeholder="密码" v-model="pwd" maxlength="16" @focus="focusBorder(2)" @blur="notNullContent(2, $event)" /><div>密码为必填项目</div></div>
          <div><input type="password" placeholder="再次输入密码" maxlength="16" v-model="pwdAgain" @blur="verifyPwd" @focus="focusBorder(3)" /><div></div></div>
      ...
      <div v-else class="register-teacher">
        ...
        <div>
          <div><input type="text" placeholder="账号" maxlength="20" v-model="account" @blur="verifyAccountExist" @focus="focusBorder(1)" /><div></div></div>
          <div><input type="password" placeholder="密码" v-model="pwd" maxlength="16" @focus="focusBorder(2)" @blur="notNullContent(2, $event)" /><div>密码为必填项目</div></div>
          <div><input type="password" placeholder="再次输入密码" maxlength="16" v-model="pwdAgain" @blur="verifyPwd" @focus="focusBorder(3)" /><div></div></div>
          <div><input type="text" placeholder="姓名" v-model="name" @focus="focusBorder(4)" @blur="notNullContent(4, $event)" /><div>姓名为必填项目</div></div>
          <div>
